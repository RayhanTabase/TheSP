...
# from .models import CustomError, User, ActivationCode
...
#         create_activation_code(user2.username)

#     def test_get__user1(self):
#         try:
#             user = User.objects.get(username__icontains ='user1')
#         except Exception as e:
#             raise Exception(e)

#     def test_get__user2(self):
#         try:
...
#         try:
#             user2 = User.objects.get(username__icontains ='user2')
...
#         except Exception as e:
#             # print(str(e))
#             if "UNIQUE constraint failed: user_user.username" in str(e):
#                 pass
#             else:
#                 raise Exception(e)
...
#         except Exception as e:
#             if "UNIQUE constraint failed: user_user.email" in str(e):
#                 pass
#             else:
#                 raise Exception(e)
...
#         except Exception as e:
#             if "UNIQUE constraint failed: user_user.phone_number" in str(e):
#                 pass
#             else:
#                 raise Exception(e) 
...
#         response = self.client.get("/check_username/user1/")
...
#     def test_register_page_valid_post(self):
...
#         )
#         self.assertEqual(response.status_code, 302)
#         # Test new user set to inactive pending activation
#         user = User.objects.get(username__icontains = "super227")
...
#         response = self.client.post("/login/", {'username': 'user4', 'password': 'userpassword'})
#         self.assertEqual(response.status_code, 200)
...
#     def test_edit_user_profile_page_post(self):
#         self.client.login(username ="user1",password ="userpassword")
#         response = self.client.post("/user/edit/",{
#             "username": "KwabenaBabone",
#             "first_name" : "Kwame",
#             "last_name" : "Babone" ,
#             "other_names" :"Y K",
#             "email":"kkkooodd@opc.com",
