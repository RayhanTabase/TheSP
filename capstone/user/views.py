...
# Javascript API request, Returns user details; name,contact, profile image
def check_username(request, username):
    ...
    # Return json of name(first,other and last), contact and profile_picture url 
...
def reset_password_email(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # print(token, reset_link)
            print("This is the link u barb", HttpResponseRedirect(reverse('reset_password_page',kwargs={"user_id":user.id})))
